...
if node['hadoop'].key?('core_site') && node['hadoop']['core_site'].key?('hadoop.security.authorization') &&
  ...
  default['krb5_utils']['krb5_service_keytabs']['mapr'] = { 'owner' => 'mapr', 'group' => 'mapr', 'mode' => '0640' }
  ...
  #default['krb5_utils']['krb5_service_keytabs']['hbase'] = { 'owner' => 'mapr', 'group' => 'mapr', 'mode' => '0640' }
  #default['krb5_utils']['krb5_service_keytabs']['hive'] = { 'owner' => 'mapr', 'group' => 'mapr', 'mode' => '0640' }
  #default['krb5_utils']['krb5_service_keytabs']['mapred'] = { 'owner' => 'mapred', 'group' => 'hadoop', 'mode' => '0640' }
  #default['krb5_utils']['krb5_service_keytabs']['spark'] = { 'owner' => 'mapr', 'group' => 'mapr', 'mode' => '0640' }
  #default['krb5_utils']['krb5_service_keytabs']['yarn'] = { 'owner' => 'yarn', 'group' => 'hadoop', 'mode' => '0640' }
  #default['krb5_utils']['krb5_service_keytabs']['zookeeper'] = { 'owner' => 'mapr', 'group' => 'mapr', 'mode' => '0640' }
  ...
  default['hadoop']['container_executor']['allowed.system.users'] = 'cdap'
  default['hadoop']['container_executor']['banned.users'] = ''
  default['hadoop']['container_executor']['min.user.id'] = 500
  default['hadoop']['container_executor']['yarn.nodemanager.linux-container-executor.group'] = 'mapr'
  ...
  default['hadoop']['container_executor']['yarn.nodemanager.log-dirs'] = '/opt/mapr/hadoop/hadoop-2.7.0/logs/userlogs'
  ...
  default['hadoop']['core_site']['hadoop.proxyuser.hive.hosts'] = '*'
   ...
   # hadoop-env.sh
=begin
  default['hadoop']['hadoop_env']['hadoop_secure_dn_user'] = 'mapr'
...
=end
  ...
  default['spark']['spark_defaults']['spark.history.kerberos.principal'] = "mapr/_HOST@#{node['krb5']['krb5_conf']['realms']['default_realm'].upcase}"
  default['spark']['spark_defaults']['spark.history.kerberos.keytab'] = "#{node['krb5_utils']['keytabs_dir']}/mapr.service.keytab"
